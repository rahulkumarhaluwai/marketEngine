  ...
  if (!userId) {
    return (
      <main className="min-h-screen bg-gray-950 text-white p-8">
        <p className="text-gray-400">Log in to view your portfolio.</p>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={refresh} className="text-sm text-indigo-400 hover:underline">
          Refresh
        </button>
      </div>
            ...
            <div className="rounded-lg border border-gray-700 p-4">
              ...
              <p
                className={`text-xl font-mono ${
                  Number(portfolio.totalUnrealizedPnl) >= 0 ? "text-green-500" : "text-red-500"
                }`}
              >
